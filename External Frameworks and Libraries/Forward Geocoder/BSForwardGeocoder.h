...
- (void)forwardGeocodeWithQuery:(NSString *)location regionBiasing:(NSString *)regionBiasing viewportBiasing:(MKMapRect)bounds; //2012-04-26 lishiyong 添加
- (void)cancel;  //2011-01-04 lishiyong 添加
...
- (void)forwardGeocodeWithQuery:(NSString *)location regionBiasing:(NSString *)regionBiasing viewportBiasing:(MKMapRect)bounds success:(BSForwardGeocoderSuccess)success failure:(BSForwardGeocoderFailed)failure; //2012-04-26 lishiyong 添加
