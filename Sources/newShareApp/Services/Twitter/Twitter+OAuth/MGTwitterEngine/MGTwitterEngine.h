...
@interface MGTwitterEngine : NSObject <MGTwitterParserDelegate> {
    ...
    id<MGTwitterEngineDelegate> _delegate;
    NSString *_username;
    NSString *_password;
...
+ (id)twitterEngineWithDelegate:(id<MGTwitterEngineDelegate>)delegate;
- (id)initWithDelegate:(id<MGTwitterEngineDelegate>)delegate;
...
- (NSString *)sendUpdate:(NSString *)status image:(UIImage*)image; //lishiyong 2012-4-16 添加
